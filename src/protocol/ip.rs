...
use crate::protocol::packet::{
    HeaderDataIcmp, HeaderDataIpv4, HeaderDataIpv6, HeaderDataTcp, HeaderDataUdp,
};
...
pub fn ipv4_handler(ether: &EthernetPacket) {
    if ether.get_ethertype() == EtherTypes::Ipv4 {
        ...
        if packet.get_next_level_protocol() == IpNextHeaderProtocols::Tcp {
            ...
            println!("Source:{} | Ipv4 {}| Destination:{} | Ipv4 {} | Flag:{} | Ipv4 {} | Payload: {:#?} | ttl: {} | Version: {} ",
                            source,
                            source_ipv4,
                            destination,
                            destination_ipv4,
     ...
     : {} | Ipv4 {} | Payload: {:#?} | ttl: {} | Version: {} ",
        ...
        // Handler ICMP
            ...
            let version = packet.get_version();
            println!(
                "Source_Ipv4: {} | IcmpType: {:#?} | Destination Ipv4: {} | Flag
       : {} | Payload: {:#?} | ttl: {} | Version: {} ",
...
pub fn ipv6_handler(ether: &EthernetPacket) {
    if ether.get_ethertype() == EtherTypes::Ipv6 {
        ...
        if packet.get_next_header() == IpNextHeaderProtocols::Tcp {
            ...
            let destination = tcp.get_destination();
            let destination_ipv6 = packet.get_destinations();
            let flag = tcp.get_flags();
            let payload = tcp.get_payload();
            let version = packet.get_version();
            println!("Source: {} | Ipv6: {} | Destination: {} | Ipv6: {} | flag: {} | Payload: {:#?} | Version: {} ",
                            source,
                            source_ipv6,
                            destination,
                            destination_ipv6,
            ...
            let version = packet.get_version();
            println!(
                "Source_Ipv6:{} | IcmpType: {:#?} | Destination Ipv6: {} | Payload: {:#?} | Version: {} ",
